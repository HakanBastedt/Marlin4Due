...
//#define MESH_BED_LEVELING    // Enable mesh bed leveling
  ...
  #define MESH_MIN_X (X_MIN_POS + 10)
  #define MESH_MAX_X (X_MAX_POS - 10)
  #define MESH_MIN_Y (Y_MIN_POS + 10)
...
//#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 0.0     // Probe on: -left  +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0.0   // Probe on: -front +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0.0  // -below (always!)
...
// build by the user have been successfully uploaded into firmware.
#define STRING_VERSION "1.0.3 dev"
#define STRING_URL "Hakan"
#define STRING_VERSION_CONFIG_H __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Hakan, Laser)" // Who made the changes.
#define STRING_SPLASH_LINE1 "v" STRING_VERSION // will be shown during bootup in line 1
//#define STRING_SPLASH_LINE2 STRING_VERSION_CONFIG_H // will be shown during bootup in line2
...
// #define CUSTOM_MENDEL_NAME "Marlin4Due"
...
// If you are using a pre-configured hotend then you can use one of the value sets by uncommenting it
// E3D
    #define  DEFAULT_Kp 27.82
    #define  DEFAULT_Ki 3.78
    #define  DEFAULT_Kd 51.20
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,200,4000,500} 			// default steps per unit for SparkCube 1/64µsteps
#define DEFAULT_MAX_FEEDRATE          {9000, 9000, 4, 150}  			// (mm/sec)
